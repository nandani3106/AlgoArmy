                ...
                <div className="flex items-center gap-4">
                   ...
                   {currentQ.difficulty && (
                     <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${
                       currentQ.difficulty === 'Easy' ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 
                        ...
                        {currentQ.options.map((opt, i) => (
                          ...
                          >
                            <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black transition-all ${
                              currentAns.answer === opt ? 'bg-white/10 text-white' : 'bg-[#1b1e36] text-slate-400 group-hover:text-orange-500'
                            }`}>
