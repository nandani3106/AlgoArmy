          ...
          interviews.map((user) => (
            ...
            >
              ...
              <div className="grid md:grid-cols-5 gap-4 mb-6">
                <ScoreCard label="Confidence" value={user.confidence} isDark={isDark} />
                <ScoreCard label="Communication" value={user.communication} isDark={isDark} />
                <ScoreCard label="Technical" value={user.technical} isDark={isDark} />
                <ScoreCard label="Problem Solving" value={user.problemSolving} isDark={isDark} />
                <ScoreCard label="Overall" value={user.overall} isDark={isDark} />
              </div>
